    ...
    <div dir="rtl">
      ...
      <nav>
        ...
        <ul className="n-links">
          <li><a href="#why">المزايا</a></li>
          <li><a href="#booth">البوث</a></li>
      ...
      <section className="hero">
        ...
        <div className="h-content">
          ...
          <div className="h-sponsor animate-fu-1">برعاية جامعة الإمام محمد بن سعود الإسلامية</div>
          ...
          <div className="ct-grid">
            <Rev>
              ...
              <div className="ct-cards">
                ...
                <div className="ccard"><div className="cc-ico">📞</div><div><div className="cc-lbl">العلاقات العامة</div><div className="cc-val"><a href="tel:+966534831944" style={{ color:"var(--glt)" }}>0534831944</a></div></div></div>
                <div className="ccard"><div className="cc-ico">🏫</div><div><div className="cc-lbl">الجهة المنظِّمة</div><div className="cc-val">نادي TechNation × نادي المالية</div></div></div>
                <div className="ccard"><div className="cc-ico">📅</div><div><div className="cc-lbl">الموعد</div><div className="cc-val">5–6 مايو 2026 · بهو جامعة الإمام</div></div></div>
              </div>
            </Rev>
      ...
      {/* WA FIXED */}
      <a className="wa-btn" href={WA} target="_blank" rel="noreferrer" title="واتساب">
